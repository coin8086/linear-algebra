...
- [4 向量空间](#4-向量空间)
  - [4.1 向量空间与子空间](#41-向量空间与子空间)
    - [向量空间的定义](#向量空间的定义)
    - [子空间的定义](#子空间的定义)
    - [由一个集合生成的子空间](#由一个集合生成的子空间)
  - [4.2 零空间、列空间和线性变换](#42-零空间列空间和线性变换)
    - [矩阵的零空间](#矩阵的零空间)
    - [矩阵的列空间](#矩阵的列空间)
    - [线性变换及其核与值域](#线性变换及其核与值域)
  - [4.3 线性无关和基](#43-线性无关和基)
    - [线性无关/相关](#线性无关相关)
    - [基](#基)
    - [生成集定理](#生成集定理)
    - [$\\mathrm{Nul} \\ A$ 和 $\\mathrm{Col} \\ A$ 的基](#mathrmnul--a-和-mathrmcol--a-的基)
  - [4.4 坐标系](#44-坐标系)
    - [坐标的定义](#坐标的定义)
    - [$\\mathbb{R}^n$ 中的坐标](#mathbbrn-中的坐标)
    - [坐标映射](#坐标映射)
  - [4.5 向量空间的维数](#45-向量空间的维数)
    - [维数的定义](#维数的定义)
    - [有限维空间的子空间](#有限维空间的子空间)
    - [$\\mathrm{Nul} \\ A$ 和 $\\mathrm{Col} \\ A$ 的维数](#mathrmnul--a-和-mathrmcol--a-的维数)
  - [4.6 秩](#46-秩)
    - [行空间](#行空间)
    - [秩](#秩)
    - [秩与可逆矩阵](#秩与可逆矩阵)
  - [4.7 基的变换](#47-基的变换)
    - [坐标变换矩阵](#坐标变换矩阵)
    - [$\\mathbb{R}^n$ 中基的变换](#mathbbrn-中基的变换)
...
$C \mathbf{x} = \mathbf{b}_1$ ， $\mathbf{x}$ 即 $[\mathbf{b}_1]_C$

$\vdots$

$C \mathbf{x} = \mathbf{b}_n$ ， $\mathbf{x}$ 即 $[\mathbf{b}_n]_C$
