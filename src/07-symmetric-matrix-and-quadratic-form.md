...
- [7 对称矩阵和二次型](#7-对称矩阵和二次型)
  - [7.1 对称矩阵的对角化](#71-对称矩阵的对角化)
    - [对称矩阵的正交对角化](#对称矩阵的正交对角化)
    - [对称矩阵的谱定理和谱分解](#对称矩阵的谱定理和谱分解)
    - [投影矩阵 \*](#投影矩阵-)
  - [7.2 二次型](#72-二次型)
    - [二次型的定义](#二次型的定义)
    - [二次型的变量代换](#二次型的变量代换)
  ...
  - [7.4 奇异值分解](#74-奇异值分解)
    ...
    - [奇异值分解](#奇异值分解)
    - [基本子空间的基](#基本子空间的基)
    - [简化的奇异值分解、伪逆和最小二乘解](#简化的奇异值分解伪逆和最小二乘解)
  - [7.5 图像处理和统计学的应用](#75-图像处理和统计学的应用)
    - [均值和协方差](#均值和协方差)
    - [主成分分析](#主成分分析)
