...
本章以对称矩阵的正交对角化（正交变量代换）为核心，分别介绍了它在二次型和奇异值分解中的作用。本章主要概念、定理和方法之间的关系如下：

![对称矩阵与正交对角化](./assets/07-relations-a.svg)

![二次型与主轴定理](./assets/07-relations-b.svg)

![奇异值分解及其应用](./assets/07-relations-c.svg)

其中，

* 带箭头的实线表示两个实体之间的依赖关系
* 虚线表示两个实体之间有重要关联但非依赖关系
* 灰色背景的实体属于之前章节的内容
